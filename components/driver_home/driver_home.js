...
class DriverHome extends Component {
  ...
  async confirm1(id){
    ...
    const options = {
        ...
        data: submitForm,
        url: "https://footubi.com/dev/speedcourier/order/driverAccept.php",
    };
    try {
  ...
  async getData(){
    ...
    orderForm.append("company",this.state.company);
    ...
    const options = {
      ...
      headers: {"content-type": "multipart/form-data"},
      data: orderForm,
      url: "https://footubi.com/dev/speedcourier/order/pendingDriver.php",
    };
    try {
      const response = await axios(options);
      console.log(response)
